...
def setTitle(_str):
    system = os.name
    if system == 'nt':
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str}915-Nuker     |    Made by 915#0001    |    Tokens: [{counttokens}]")
    elif system == 'posix':
        sys.stdout.write(f"{_str}915-Nuker    |    Made by 915#0001    |    Tokens: [{counttokens}]")
    else:
        pass
